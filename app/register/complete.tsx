...
export default function RegisterComplete() {
  ...
  const goHome = async () => {
    ...
    // Compose user data from registration draft
    const basics = getBasics();
    ...
    const result = await registerUser({
      ...
      known_conditions: details.known_conditions,
      allergies: details.allergies,
      food_tolerance: details.food_tolerance,
      smoking: details.smoking,
      alcohol: details.alcohol,
      physical_activity: details.physical_activity,
